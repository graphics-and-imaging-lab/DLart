...
class GoogleImageExtractor(object):
    ...
    def __init__(self, search_key = '' ):
        ...
        self.folder_main_dir_prefix = r'/home/mlagunas/DLart/curated'
    ...
    def download_single_image(self, url_link, pic_prefix_str):
        ...
        url_link = url_link.replace("%3A", ":")
        url_link = url_link.replace("%2F", "/")
        url = URL(url_link)
...
if __name__ == '__main__':
    ...
    searchlist_filename = r'/home/mlagunas/DLart/curated/list.txt'
